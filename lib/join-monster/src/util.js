...
// TODO
export function checkFilterValidity(filter, queryASTNode) {
    console.log("queryASTNode", queryASTNode);
    console.log("filter", filter);
    console.log("Flattened filter.OR", _.flattenDeep(filter.AND));

    if (filter.compare) {
        _checkComparisonValidity(filter.compare, queryASTNode);
    } else if (filter.OR) {
...
function _checkComparisonValidity({ key, operator }, queryASTNode) {
...
export async function compileSqlAST(sqlAST, context, options) {
    //console.log("qsqlAST in util", sqlAST);
