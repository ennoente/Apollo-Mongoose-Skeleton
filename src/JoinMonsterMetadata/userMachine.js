...
extendJmMutation('deleteUserMachine', {
    refType: 'UserMachine',
    authorization: ({ id }, ctx) => ({
        id: {
            refType: 'UserMachine',
...
extendJmMutation('updateUserMachine', {
    refType: 'UserMachine',
    authorization: ({ id, input }, context) => ({
        id: {
            refType: 'UserMachine',
...
extendJmMutation('createUserMachine', {
    refType: 'UserMachine',
